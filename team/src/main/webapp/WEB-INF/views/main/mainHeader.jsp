	    ...
	    <div class="contents">
	        ...
	        <ul class="header_login">
	          <li class="header_con"><a href="login" class="header_a"><img src="https://img.cgv.co.kr/R2014/images/common/ico/loginPassword.png" alt="로그인" class="cgv_img"/><span>로그인</span></a></li>
	            ...
	            <li class="header_con"><a href="userPage?u_id=wjdcksgml" class="header_a"><img src="https://img.cgv.co.kr/R2014/images/common/ico/loginMember.png" alt="마이페이지" class="cgv_img"/><span>마이페이지</span></a></li>
		  ...
		  <div class="container-fluid">
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        ...
		        <li class="nav-item dropdown">
		          ...
		          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
		            ...
		            <li><a class="dropdown-item" href="reviewList">리뷰보기</a></li>
		          </ul>
		        </li>
		      ...
		      <form class="d-flex" role="search">
		        <input class="form-control me-2 sm" type="search" placeholder="제목으로 검색" aria-label="Search">
