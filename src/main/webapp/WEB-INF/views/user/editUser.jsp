	...
	<table align="center" width="800px" border="1px solid black">
		<form name="reg_frm" method="post" action="editUserOk">
			...
			<tr>
				...
				<td>
  					<div>
   						<input type="text" class="id_input" name="u_id" value="${dto.u_id}" readonly="readonly"><br>
					</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="2">
				  <div>
					<input type="text" size="20" name="u_name" value="${dto.u_name}" readonly="readonly">
				  </div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3" align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="submit" onclick="check_ok()" value="정보수정"> 
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="button" value="수정안함" onclick="location.href='login'">
				</td>
			</tr>
		</form>
	</table>
